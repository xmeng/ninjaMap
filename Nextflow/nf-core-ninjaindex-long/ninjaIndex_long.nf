...
/*
========================================================================================
                         nf-core/ninjaindex-long
========================================================================================
 nf-core/ninjaindex Pipeline for long reads.
...
process long_fastq {
  ...
  tag "$fna"
	publishDir "${params.outdir}/long_fastqs", mode:'copy'
...
*
   STEP 3
   Generate the minimap2 mapping for all genomes
*/
...
process minimap2_mapping {
    ...
    script:
    """
    run_minimap2.sh $all_genome $fq &> minimap2.log
    """
}
...
process generate_Ninja_Index {
  ...
  output:
  file "tmp_*/Sync/ninjaIndex/*.ninjaIndex.long.binmap.csv"
  file "tmp_*/Sync/ninjaIndex/*.ninjaIndex.long.fasta"
