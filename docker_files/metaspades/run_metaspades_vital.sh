...
QUAST_OUTPUT="${LOCAL_OUTPUT}/metaquast"
...
bwa mem "${ASSEMBLY_OUTPUT}/contigs.fasta" "${BAMQC_OUTPUT}/read1_trimmed.fastq.gz" "${BAMQC_OUTPUT}/read2_trimmed.fastq.gz" > "${BAMQC_OUTPUT}/reads_aligned_contigs.sam"
